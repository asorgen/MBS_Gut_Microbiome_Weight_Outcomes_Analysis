...
taxaNames <- taxaNames[taxaNames$adjPValues < 0.05,]; features <- " Significant "; outputName <- "_Significant"
...
# meta.df <- myT[which(myT$Timepoint == "ONE"), c("PatientID", "Age", "Site", "Sex", "Ethnicity", "Surgery", "Loss_from_BL_BMI", "Percent_Loss_kg") ]
