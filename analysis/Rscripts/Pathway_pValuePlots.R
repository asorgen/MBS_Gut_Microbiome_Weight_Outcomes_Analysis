...
#Date: 2022 June 09
#Description: Linear modeling for pathway by time
...
prevModule <- paste0(classifier, "_Pathway_over_time_BLto", included[length(included)], "M")
...
title.lab <- paste0(classifier, " pathway changes over time (BL to ", included[length(included)], " months)")
...
# Print the plot
file.path <- paste0(outputDir, "Pathway_by_Timepoint_", division, "_LM_pValue_boxplot_BLto", included[length(included)], "M_", classifier, ".pdf")
...
title.lab <- paste0(classifier, " pathwat changes over time (BL to ", included[length(included)], " months)")
subtitle.lab <- paste0("Fisher's Exact Test (", f.pVal, ")")
...
# Print the plot
file.path <- paste0(outputDir, "Pathway_by_Timepoint_", division, "_LM_pValue_scatterplot_BLto", included[length(included)], "M_", classifier, ".pdf")
