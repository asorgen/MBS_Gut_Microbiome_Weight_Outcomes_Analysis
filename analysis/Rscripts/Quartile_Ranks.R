...
moduleRoot <- paste0("Quartile_Ranks")
...
plot <- plot + annotate(geom="text", x=10, y=(Q_24M/2), label="Bottom 25%",
                          color="red"); plot
plot <- plot + annotate(geom="text", x=nrow(df.12M)-10, y=nrow(df.24M), label="Top 25%",
                        color="red"); plot
plotList[[1]] <- plot
...
plot <- plot + annotate(geom="text", x=10, y=(Q_24M/2), label="Bottom 25%",
                        color="red"); plot
plot <- plot + annotate(geom="text", x=nrow(df.18M)-10, y=nrow(df.24M), label="Top 25%",
                        color="red"); plot
plotList[[2]] <- plot
...
plot <- plot + annotate(geom="text", x=10, y=(Q_18M/2), label="Bottom 25%",
                        color="red"); plot
plot <- plot + annotate(geom="text", x=nrow(df.12M)-10, y=nrow(df.18M), label="Top 25%",
                        color="red"); plot
plotList[[3]] <- plot


plotFileName <- "weight_loss_ranking_plots_quartile.pdf"
