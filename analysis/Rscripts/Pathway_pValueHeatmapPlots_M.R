...
moduleRoot <- "Pathway_pValueHeatmapPlots_M"
...
if (args[1] == "BLJ") {
  ...
  if (args[2] == "MetaPhlAn2" | args[2] == "Kraken2") {
    ...
    module <- gsub("Pathway", args[2], module); module
  } 
...
prevModule <- paste0(classifier, "_Pathway_over_time_", endM, "M_Weight_Class_BLto", included[length(included)], "M"); prevModule
...
message("\n>>>>> Outputting plot")
# Output plot
file.path <- paste0(outputDir, "Pathway_", endM, "M_Heatmap.pdf")
